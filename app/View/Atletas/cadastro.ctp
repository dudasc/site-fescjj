...
<br>
<?php
 echo $this -> Form -> create('Atleta', array('action' => 'cadastro', 'type' => 'file', 'enctype'=>"multipart/form-data", 'id' => 'form-filiacao'));
?>
...
<br>
 <?php 
		//echo $this -> Html -> link('Voltar', array('controller' => 'filiacoes', 'action' => 'index'), 
